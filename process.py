...
# saving the Scaler
os.makedirs("models", exist_ok = True)         # os.make_dirs() = make a floder 
joblib.dump(scaler, "models/house_scaler.pkl") # joblib,dump() = it uses to save 

# saving the Traing columns
TRAIN_COLUMNS = df.drop(columns=["Price", "LogPrice"]).columns.to_list()
json.dump(TRAIN_COLUMNS, open("models/train_columns.json", "w")) # json.dump() = it means save as json
...
# 10) Save
OUT_PATH = "dataset\house_dataset_clean.csv"
